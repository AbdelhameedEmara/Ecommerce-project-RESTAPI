...
async function login(req, res) {
  try {
    ...
    if (foundUser) {
      passwordIsValid = bcrypt.compareSync(user.password, foundUser.password); //here compare between pass in log & reg(indb)
      if (passwordIsValid) {
...
///////////////////////////////////////// EDIT, DELETE, GET /////user Can edit, delete his own info
